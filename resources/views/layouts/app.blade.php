...
<body>
    <div id="app">
    <!-- <img src="{{ asset('img/banner.png') }}" class="site-branding" /> -->
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name ?? Auth::user()->phone_number }} <span class="caret"></span>
                                </a>
                                ...
                                <a class="dropdown-item" href="{{ route('user.edit', Auth::user() ) }}">Redigera din profil</a>
